...
public class DAOLlamadas {
    ...
    public List<String> ListarLlamadas(Activity contexto, String tLlamada){
        ...
        try {
            ...
            if (oRegistro.moveToFirst()){
                do {
                    ...
                    String tipoActual = tipoLlamada[itipo - 1];

                    if (tLlamada.equals(tipoActual)) {
                        lista.add("Llamada " + tipoActual + " - Número: " + numero);
                    }
                    if (tLlamada.equals("Todas las Llamadas")){
                        lista.add("Llamada " + tipoActual + " - Número: " + numero);
                    }
